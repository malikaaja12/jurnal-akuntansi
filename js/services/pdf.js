...
export const pdfService = {
  ...
  async generateCategoryPDF() {
    utils.showModal(
      "Info",
      '<div class="text-center"><i class="fas fa-spinner fa-spin text-2xl text-purple-500"></i><p class="mt-2">Mempersiapkan Laporan PDF</p></div>',
    );
    await new Promise((resolve) => setTimeout(resolve, 100));
    ...
    doc.save(`Laporan_Keuangan${state.currentMonth}.pdf`);
    utils.closeModal();
  },
};
