...
// Gunakan window.app.renderAll() untuk menghindari circular import (copy.js ↔ app.js)
function renderAll() { if (window.app) window.app.renderAll(); }
...
// addKelompok() dan deleteKelompok() sudah dipindah ke kelompok.js
